...
if /i "!EXITTHREAD_TLS_DTOR!"=="YES" (
  echo EXITTHREAD_CURRENT_BEHAVIOR=RUN_WRAPPER_DTOR_AND_RECLAIM
  ...
  echo EXITTHREAD_FAIL_CLOSED_REQUIRED=NO
  echo N6_07_02_CLASS=IMPLEMENTED_RUN
) else (
...
if /i "!ENDTHREADEX_TLS_DTOR!"=="1" (
  echo ENDTHREADEX_CURRENT_BEHAVIOR=RUN_WRAPPER_DTOR_AND_RECLAIM
  ...
  echo ENDTHREADEX_FAIL_CLOSED_REQUIRED=NO
  echo N6_07_03_CLASS=IMPLEMENTED_RUN
) else if /i "!ENDTHREADEX_TLS_DTOR!"=="YES" (
  echo ENDTHREADEX_CURRENT_BEHAVIOR=RUN_WRAPPER_DTOR_AND_RECLAIM
  echo ENDTHREADEX_TLS_DTOR=!ENDTHREADEX_TLS_DTOR!
  echo ENDTHREADEX_TLS_RECLAIM=!ENDTHREADEX_TLS_RECLAIM!
  echo ENDTHREADEX_LINK_INTERCEPT_FEASIBLE=YES
