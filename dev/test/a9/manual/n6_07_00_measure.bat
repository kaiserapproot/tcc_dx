...
echo USE_AFTER_FREE_RISK=CONFIRMED
call :parse_kv "!HLOG!" THREAD_EXIT_AFTER_TCC_DELETE_CRASH KV_CRASH1
if defined KV_CRASH1 echo THREAD_EXIT_AFTER_TCC_DELETE_CRASH=!KV_CRASH1!
call :parse_kv "!HLOG!" DTOR_ATTEMPT_AFTER_TCC_DELETE_CRASH KV_CRASH2
if defined KV_CRASH2 echo DTOR_ATTEMPT_AFTER_TCC_DELETE_CRASH=!KV_CRASH2!
echo N6_07_DIRECT_RELOCATE_LIVE_TLS_DELETE=REQUIRED_FAIL_CLOSED_DECISION
echo CURRENT_BEHAVIOR=PENDING_DTOR_CAN_EXIST_AT_TCC_DELETE
echo CURRENT_CRASH_STATUS=NOT_REPRODUCED_ON_BENIGN_EXIT_UAF_ON_EXPLICIT_DTOR_CALL
echo TCC_DELETE_FAIL_CLOSED_REQUIRED=YES
echo SAFETY_STATUS=UNPROVEN
echo N6_07_04_CLASS=SAFETY_HAZARD
