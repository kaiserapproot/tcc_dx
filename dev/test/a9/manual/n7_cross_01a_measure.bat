...
call :expect_compile_fail n7_cross_01a_d_global_func GLOBAL_CLASS_FUNCTION_CALL_INIT
call :expect_compile_fail n7_cross_01a_e_global_const GLOBAL_CONST_CLASS_FUNCTION_CALL_INIT
call :expect_compile_fail n7_00_minimal_static_dyninit AMATERAS_MIN_REPRO_A
call :expect_compile_fail n7_cross_01a_minimal_dyninit AMATERAS_MIN_REPRO_B
...
echo N7_CROSS_01B_FIX_START=YES
popd
exit /b 0
